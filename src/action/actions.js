...
export const actionAddEventsRequest = (event) => {
    return async (dispatch) => {
        ...
        return axios({
            method: 'POST',
            url: 'http://localhost:8081/cleansite',
            data: event
        }).then(res => {
...
export const actionDeleteEventsRequest = (id) => {
    return async (dispatch) => {
        ...
        return axios({
            method: 'POST',
            url: `http://localhost:8081/cleansite/delete/${id}`,
            data: null
        }).then(res => {
...
export const actionEditEventsRequest = (event, id) => {
    return async (dispatch) => {
        return axios({
            method: 'PUT',
            url: `http://localhost:8081/cleansite/${id}`,
            data: event
        }).then(res => {
...
export const actionFetchEventsRequest = () => {
    return async (dispatch) => {
        return axios({
            method: 'GET',
            url: 'http://localhost:8081/cleansite/all',
            data: null
        }).then(res => {
...
export const actionFetchEventsByOwnerRequest = (ownerId) => {
    return async (dispatch) => {
        ...
        return axios({
            method: 'GET',
            url: `http://localhost:8081/account/${ownerId}/ownevent`,
            data: null
        }).then(res => {
...
export const actionFetchVolunteersByEmailRequest = (email) => {
    return async (dispatch) => {
        return axios({
            method: 'GET',
            url: `http://localhost:8081/volunteer/${email}`,
            data: null
        }).then(res => {
...
export const actionAddVolunteersRequest = (volunteer) => {
    return async (dispatch) => {
        return axios({
            method: 'POST',
            url: 'http://localhost:8081/volunteer',
            data: volunteer
        }).then(res => {
...
export const actionFetchVolunteersRequest = () => {
    return async (dispatch) => {
        return axios({
            method: 'GET',
            url: 'http://localhost:8081/volunteer/all',
            data: null
        }).then(res => {
...
export const actionAddSiteVolunteerRequest = (volunteer) => {
    return async (dispatch) => {
        return axios({
            method: 'POST',
            url: 'http://localhost:8081/sitevolunteer',
            data: volunteer
        }).then(res => {
...
export const actionFetchVolunteersBySiteRequest = (siteID) => {
    return async (dispatch) => {
        return axios({
            method: 'GET',
            url: `http://localhost:8081/cleansite/${siteID}/volunteer`,
            data: null
        }).then(res => {
...
export const actionDownloadEventsByAccountRequest = (accountId, accountName) => {
    return async (dispatch) => {
        ...
        return axios({
            method: 'GET',
            url: `http://localhost:8081/account/${accountId}/ownevent/download`,
            data: null,
            responseType: 'blob'
        }).then(res => {
...
export const actionDownloadVolunteersBySiteRequest = (siteID, siteName) => {
    return async (dispatch) => {
        return axios({
            method: 'GET',
            url: `http://localhost:8081/cleansite/${siteID}/volunteer/download`,
            data: null,
            responseType: 'blob'
        }).then(res => {
...
export const actionFetchAccountsByIDRequest = (accountID) => {
    return async (dispatch) => {
        return axios({
            method: 'GET',
            url: `http://localhost:8081/account/${accountID}`,
            data: null
        }).then(res => {
            console.log(res.data[0], "get by id")
